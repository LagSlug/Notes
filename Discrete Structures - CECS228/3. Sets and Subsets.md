...
# 3.4 Difference and Symmetric Difference
...
- Sets use curly braces, indicating that the order in which the elements are listed does not matter.
- For example, {x, y} is equal to {y, x}.
...
- I.e. disjoint sets are non-overlapping.
